...
Skill(
        ...
        "#3178C6",
        `Used for a few personal projects.`,
        "languages"
    );
...
Skill(
        ...
        "#0769AD",
        `One of the languages that inspired me to take Computer Science seriously in high school and ultimately got me into software engineering. I was 12 when I used it to <a href="https://github.com/lynkos/old-tumblr-themes" target="_blank" title="Link to my old Tumblr themes I made as a pre-teen and teen">create Tumblr themes</a>. I now use it extensively for many of my personal projects.`,
        "languages"
    );
...
Skill(
        ...
        "#A8B9CC",
        `First learned in college. Used for coursework pertaining to systems programming and embedded development. Also used for my Capstone II project, specifically the hardware abstraction layer (i.e. ESP32 camera).`,
        "languages"
    );
...
Skill(
        ...
        "#008080",
        `Used extensively for my resumes and cover letters.`,
        "languages"
    );
...
Skill(
        ...
        "#CB171E",
        `Used on various projects for CI/CD.`,
        "languages"
    );
...
Skill(
        ...
        "#FABD14",
        `Used for Software Engineering coursework.`,
        "languages"
    );
...
Skill(
        ...
        "#276DC3",
        `Used for basic personal experiments.`,
        "languages"
    );
...
Skill(
        ...
        "#CC342D",
        `Used to add plugins and customizations to <a target="_blank" href="https://github.com/lynkos/blog" title="Link to my blog's GitHub">my Jekyll blog</a>.`,
        "languages"
    );
...
Skill(
        ...
        "#005FAD",
        `Used for my coursework, projects, and internships.`,
        "languages"
    );
...
Skill(
        ...
        "#4EAA25",
        `Commonly used for scripting and automation tasks in my development workflow. Also used during my internships at Oracle (OCI).`,
        "tools"
    );
...
Skill(
        ...
        "#F15A24",
        `Not really used since I prefer Bash, but I'm still proficient at it.`,
        "tools"
    );
...
Skill(
        ...
        "#F37626",
        `Used for my Quantum Search Algorithm (i.e. Grover's Algorithm) implementation. Also used for my Capstone II project.`,
        "tools"
    );
...
Skill(
        ...
        "#44A833",
        `Used for all my Python projects.`,
        "tools"
    );
...
Skill(
        ...
        "#800000",
        `Used for my personal project, so that I can play Windows games on my MacBook Pro M3 Max.`,
        "tools"
    );
...
Skill(
        ...
        "#FBB040",
        `My preferred package manager on macOS.`,
        "tools"
    );
...
Skill(
        ...
        "#2088FF",
        `Used for building and deploying both my personal website and blog.`,
        "tools"
    );
...
Skill(
        ...
        "#222",
        `Used for both my personal website and blog.`,
        "tools"
    );
...
Skill(
        ...
        "#7C3AED",
        `Used for my personal knowledge management and note-taking. I post some of my notes to my blog.`,
        "tools"
    );
...
Skill(
        ...
        "#175DDC",
        `Use daily for password management.`,
        "tools"
    );
...
Skill(
        ...
        "#84BD00",
        `Used regularly during my internships at Oracle (OCI).`,
        "tools"
    );
...
Skill(
        ...
        "#eb3c00",
        `Used my entire life, including in elementary, middle, and high school, as well as college, my internships at Oracle (OCI), and all other professional experiences.`,
        "tools"
    );
...
Skill(
        ...
        "#F2CA30",
        `Used for authentication of my personal projects and during my internships at Oracle (OCI).`,
        "tools"
    );
...
Skill(
        ...
        "#625DF5",
        `Used for some of my course projects.`,
        "tools"
    );
...
Skill(
        ...
        "#0052CC",
        `Used Atlassian products and tools during all of my internships at Oracle (OCI).`,
        "tools"
    );
...
Skill(
        ...
        "#0B5CFF",
        `Used during all of my internships at Oracle (OCI), along with coursework and personal meetings.`,
        "tools"
    );
...
Skill(
        ...
        "#6929C4",
        `Used for quantum computing research and development, specifically for my implementation of Quantum Search Algorithm (i.e. Grover's Algorithm).`,
        "frameworks"
    );
...
Skill(
        ...
        "#EE4C2C",
        `Used for my Capstone II project, where I implemented a convolutional neural network to detect harmful algae in natural water.`,
        "frameworks"
    );
...
Skill(
        ...
        "#3B5526",
        `Used for my project on post-quantum cybersecurity.`,
        "frameworks"
    );
...
Skill(
        ...
        "#CC6699",
        `Used in several of my web development projects, including this one.`,
        "frameworks"
    );
...
Skill(
        ...
        "#262D3A",
        `Used for a <a href="https://blog.lynkos.dev/posts/self-compiled-llm" target="_blank" title="Link to personal project">personal project where I built and ran optimized, self-compiled LLMs locally on my MacBook Pro M3 Max</a>.`,
        "frameworks"
    );
...
Skill(
        ...
        "#1fad4b",
        `Used for one of my projects during my internship at Oracle (OCI).`,
        "frameworks"
    );
...
Skill(
        ...
        "#00DC82",
        `Used for my <a href="https://github.com/hllywluis/bim-assistant" target="_blank" title="Link to Capstone I project">Capstone I project</a>.`,
        "frameworks"
    );
...
Skill(
        ...
        "#111F68",
        `Used for my <a href="https://github.com/lynkos/algae-detection" target="_blank" title="Link to Capstone II project">Capstone II project</a>.`,
        "frameworks"
    );
...
Skill(
        ...
        "#6DB33F",
        `Used during my internship at Oracle (OCI).`,
        "frameworks"
    );
...
Skill(
        ...
        `<img aria-hidden="true" loading="lazy" fetchpriority="low" alt="Apple logo" src="https://cdn.simpleicons.org/apple/D4D4D4">`,
        "#D4D4D4",
        `My main operating system of choice.`,
        "operating-systems"
    );
...
Skill(
        ...
        "#E95420",
        `Used for post-quantum cybersecurity research project.`,
        "operating-systems"
    );
...
Skill(
        ...
        "#FCC624",
        `Used for post-quantum cybersecurity research project, along with a few courses.`,
        "operating-systems"
    );
...
Skill(
        ...
        "#D97757",
        `Favorite AI assistant for coding.`,
        "llms"
    );
...
Skill(
        ...
        "#4D6BFE",
        `Occasionally used for general questions.`,
        "llms"
    );
...
Skill(
        ...
        "#8E75B2",
        `One of my top choices for coding assistance and general questions.`,
        "llms"
    );
...
Skill(
        ...
        "#019733",
        `Mainly used during my internships at Oracle (OCI). Also used for some coursework and personal projects.`,
        "editors"
    );
...
Skill(
        ...
        "#FFF",
        `Used for some coursework and internship projects at Oracle (OCI).`,
        "editors"
    );
...
Skill(
        ...
        "#2C2255",
        `The very first code editor I've ever used. Mostly used while I was in high school for development and competitive programming. Haven't used it in years, though.`,
        "editors"
    );
