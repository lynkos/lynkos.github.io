...
2. Use your own [reCAPTCHA v2](https://developers.google.com/recaptcha/docs/display#auto_render) widget and replace [`data-sitekey`](index.html#L908) in [`index.html`](index.html) with your own sitekey
...
3. Modify the code within [`<form class="gform">`](index.html#L900) (inclusive) in [`index.html`](index.html) accordingly
